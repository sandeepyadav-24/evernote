      ...
      <div className="mx-52">
        <div className="flex flex-row my-20 ">
          <div className="w-2/5  mx-10">
            ...
            <h2 className="text-xl my-3">
              ...
              the internet with Web Clipper. Scan and store your important
              files, documents, and images. Remind yourself how awesome you are
              with audio notes. No matter if it’s meeting notes, receipts,
              manuals, or family recipes, Evernote keeps them secure.
            </h2>
          </div>
          <div className="w-3/5">
            <img src="https://evernote.com/_next/image?url=%2Fimages%2Fsplit%2Fsketches.webp&w=1920&q=75"></img>
        ...
        <div className="flex flex-row  my-20 ">
          ...
          <div className="w-2/5  mx-10">
            ...
            <h2 className="text-xl my-3">
              Evernote automatically syncs across all your devices so you can
              access your most important information anytime, anywhere. No WiFi?
              No problem—offline mode means you can continue to use Evernote
              even when the internet cuts out.
            </h2>
        ...
        <div className="flex flex-row my-20 ">
          <div className="w-2/5  mx-10">
            ...
            <h2 className="text-xl my-3">
              Intuitive Evernote search features like AI-Powered Search help you
              get the right information from your notes quickly and reliably.
              And our advanced search options aren’t limited to notes: with
              Evernote, you can search your PDFs, documents, and images with
              ease.
            </h2>
          </div>
          <div className="w-3/5">
